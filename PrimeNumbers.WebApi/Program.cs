...
// add another endpoint to generate random prime numbers from 1 to 10000 and return only one random prime number
...
// create a method to check if the number is prime or not
